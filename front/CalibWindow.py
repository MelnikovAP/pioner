...
# TODO: fix warnings with the "alignment" option and some others
# TODO: divide code
...
class CalibWindow(qt.QDialog):
    def __init__(self, parent=None):
        ...
        main_layout.addWidget(self.ttplBox)
        ...
        main_layout.addWidget(self.uhtrBox)
        ...
        main_layout.addWidget(self.ihtrBox)
        lout_0 = qt.QHBoxLayout()
        ...
        main_layout.addWidget(self.thtrBox)
        lout_0 = qt.QVBoxLayout()
        ...
        main_layout.addWidget(self.thtrdBox)
        lout_0 = qt.QVBoxLayout()
        ...
        main_layout.addWidget(self.theaterBox)
        lout_0 = qt.QVBoxLayout()
        ...
        main_layout.addWidget(self.rhtrBox)
        lout_0 = qt.QHBoxLayout()
        ...
        main_layout.addWidget(self.amplcorBox)
        lout_0 = qt.QHBoxLayout()
        ...
        reg_exp = "^[-]{0,1}[0-9]{1,5}\.[0-9]{1,10}$|^[-]{0,1}[0-9]{1,5}\.[0-9]{1,10}e[-]{0,1}[+]{0,1}[0-9]{0,2}$"
        float_validator = qt.QRegExpValidator(qt.QRegExp(reg_exp))
    ...
    def save_calib_to_file(self, fpath=False):
        fpath = qt.QFileDialog.getSaveFileName(self, "Select file and path to save calibration:",
