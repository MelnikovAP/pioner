...
class Calibration:
    ...
    def read(self, path: str):
        ...
        self._add_params()
        delattr(self, '_json_calib')  # is needed in order to transfer calibration dict without it in tango pipe
    ...
    def get_str(self):
        ...
        calib_str = calib_str.replace("\'", "\"")  # is needed because json.loads does not recognize " ' "
        return calib_str
